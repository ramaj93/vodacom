...
$config['tables']['warehouses_users'] = 'warehouses_users';
...
$config['join']['warehouses_users'] = 'warehouse_id';
 ...
 */
$config['site_title']           = "CoreIT Content Management System"; 		// Site Title, example.com
