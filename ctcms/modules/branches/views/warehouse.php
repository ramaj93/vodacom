...
<script>
    ...
    "aLengthMenu": [[10, 25, 50, 100, - 1], [10, 25, 50, 100, "All"]],
            ...
            'bProcessing'    : true,
            'bServerSide'    : true,
        'sAjaxSource'    : '<?php echo base_url(); ?>index.php?module=branches&view=getwhbranches&warehouse_id=<?php echo $warehouse_id;?>',
...
<?php $links = '<li><a href="index.php?module=branches">'.$this->lang->line("all_customers").'</a></li><li class="divider"></li>';
	foreach($warehouses as $warehouse) {
		if($warehouse->id == $warehouse_id) {
			$wh_name = $warehouse->company;
			echo $wh_name;
		} else {
			$links .= "<li><a href='index.php?module=branches&view=warehouse&warehouse_id=".$warehouse->id."'>".$warehouse->company."</a></li>";
		}
	} 
	?>
