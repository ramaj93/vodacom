...
<script>
    ...
    "aLengthMenu": [[10, 25, 50, 100, - 1], [10, 25, 50, 100, "All"]],
            ...
            'bProcessing'    : true,
            'bServerSide'    : true,
            'sAjaxSource'    : '<?php echo base_url(); ?>index.php?module=logging&view=getLogs',
    ...
    aoData.push({ "name": "<?php echo $this->security->get_csrf_token_name(); ?>", "value": "<?php echo $this->security->get_csrf_hash() ?>" });
            ...
            "sSwfPath": "assets/media/swf/copy_csv_xls_pdf.swf",
                    ...
                    {
                    "sExtends": "csv",
                            "sFileName": "<?php echo $this->lang->line("logging"); ?>.csv",
                            "mColumns": [ 0, 1, 2, 3, 4, 5 ]
                    },
                    {
                    "sExtends": "pdf",
                            "sFileName": "<?php echo $this->lang->line("logging"); ?>.pdf",
...
?>
<h3 class="title"><?php echo $this->lang->line("logs") ; //. " ( <span style='color: #F00;'>".$n."</span> )"; 
...
<table id="fileData" class="table table-bordered table-hover table-striped table-condensed" style="margin-bottom: 5px;">
    <thead>
        <tr>
            ...
            <th><?php echo $this->lang->line("data_type"); ?></th>
