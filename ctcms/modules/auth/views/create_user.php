...
echo form_open("module=auth&view=create_user", $attrib); ?>
...
<div class="control-group">
    ...
    <div class="controls">
        <div class="btn-group user-role" data-toggle="buttons-radio">
            <button type="button" value="1" class="btn">
                <?php echo $this->lang->line("admin"); ?>
            </button>
            <button type="button" value="3" class="btn">
                <?php echo $this->lang->line("configuration"); ?>
            </button>
            <button type="button" value="4" class="btn">
                <?php echo $this->lang->line("project"); ?>
            </button>
            <button type="button" value="2" class="btn">
    ...
    <div class="control-group">
        ...
        <div class="controls">  <?php
            ...
            echo form_dropdown('department', $dpt, '', 'id="department" class="span4" data-placeholder="' . $this->lang->line("select") . ' ' . $this->lang->line("customer") . '" required="required" data-error="' . $this->lang->line("customer") . ' ' . $this->lang->line("is_required") . '"');
            ?> </div>
    </div>
<div class="control-group">
