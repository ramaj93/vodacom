...
<script>
    ...
    "aLengthMenu": [[10, 25, 50, 100, - 1], [10, 25, 50, 100, "All"]],
            ...
            'bProcessing'    : true,
            'bServerSide'    : true,
            'sAjaxSource'    : '<?php echo base_url(); ?>index.php?module=messaging&view=getMessages&inbox=<?php echo $inbox;?>&unread=<?php echo $unread;?>',
    ...
    aoData.push({ "name": "<?php echo $this->security->get_csrf_token_name(); ?>", "value": "<?php echo $this->security->get_csrf_hash() ?>" });
            ...
            "sSwfPath": "assets/media/swf/copy_csv_xls_pdf.swf",
                    ...
                    {
                    "sExtends": "csv",
                            "sFileName": "<?php echo $this->lang->line("msg"); ?>.csv",
                            "mColumns": [ 0, 1, 2, 3, 4, 5 ]
                    },
                    {
                    "sExtends": "pdf",
                            "sFileName": "<?php echo $this->lang->line("msg"); ?>.pdf",
...
<h3 class="title"><?php if($inbox == 1)echo $this->lang->line("inbox") ; else echo $this->lang->line("outbox"); //. " ( <span style='color: #F00;'>".$n."</span> )"; 
...
<table id="fileData" class="table table-bordered table-hover table-striped table-condensed" style="margin-bottom: 5px;">
    <thead>
        <tr>
            ...
            <th><?php if($inbox)echo $this->lang->line("from"); else echo  $this->lang->line("to"); ?></th>
